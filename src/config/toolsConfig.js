...
export const toolsConfig = {
	...
	'invoice-generator': {
		...
		routePath: '/invoice-generator',
		keywords: 'invoice generator, create invoice, business invoice, billing',
		features: [
			{
				icon: FileText,
				title: 'Professional Design',
				description: 'Create polished invoices',
			},
			{
				icon: Download,
				title: 'PDF Export',
			...
			},
			{
				...
				description: 'Automatic totals and tax',
			},
		],
	},

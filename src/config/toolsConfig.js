...
export const toolsConfig = {
	...
	'profit-loss': {
		title: 'Profit and Loss Generator',
		...
		fileTypeLabel: 'Excel or CSV file',
		requiresPassword: false,
		allowReorder: false,
		buttonLabel: 'Generate P&L Report',
		processingLabel: 'Generating P&L statement...',
		actionLabel: 'generate profit and loss report',
		outputFileName: 'sheetlypro_profit_loss.xlsx',
		keywords:
			'profit and loss, P&L statement, financial report, income statement, business report',
		hasCustomFields: true,
		customFields: [
			{
				name: 'report_period',
		...
		instructions: [
			'Upload your financial data file (Excel or CSV)',
			'Select the report period (Monthly, Quarterly, Yearly, or Custom)',
			'Optionally specify custom date range',
			'Click "Generate P&L Report" to create your statement',
		],
		features: [
			{
				icon: Table,
			...
			},
			{
				...
				description: 'Get polished, ready-to-use reports',
			},
			{
				icon: FileText,
				title: 'Multiple Periods',
				description: 'Support for various reporting periods',
			},
		],
	},
